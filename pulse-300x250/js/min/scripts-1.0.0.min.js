...
getScript(["jquery","slick"],function(){var e=$.proxy($.fn.find,$(document)),t=e(".pulse-mobile"),n=e(".pulse-mobile-wrapper").data("click"),i=function(){function i(e){e.preventDefault(),window.open(n)}function a(){var n=t.slick("getSlick"),i=n.slideCount-1;t.on("beforeChange",function(t,n,a,l){i===l&&e(".js-pulse-animate").slideUp(),e(".js-pulse-animate").is(":visible")||e(".js-pulse-animate").slideDown()})}function l(){t.slick({lazyLoad:"ondemand",rtl:!1})}function o(t){var n=e(t).data("poster");n&&t.setAttribute("poster",n)}function r(t){var n=e(t).data("src"),i=document.createElement("source");i.setAttribute("src",n),t.appendChild(i)}function s(){if(document.getElementById("pulse-player")){var n=document.getElementById("pulse-player"),i=n.parentNode.parentNode,a=e(i).data("slick-index");t.on("beforeChange",function(t,i,l,s){s===a?(o(n),r(n)):n.hasAttribute("playing")&&(n.pause(),e(".pulse-player-active").removeClass("pulse-player-active"),e(".pulse-player-pause").show(),n.removeAttribute("playing"))})}}function d(){if(document.getElementById("pulse-mobile-ad")){var n=document.getElementById("pulse-mobile-ad"),i=n.parentNode.parentNode,a=e(i).data("slick-index");t.on("beforeChange",function(t,i,l,o){if(!e(n).hasClass("js-pulse-mobile-ad-active")&&o===a){var r=e(n).data("iframe");e(n).append('<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" height="250" width="300" src="'+r+'" topmargin="0" leftmargin="0" allowtransparency="1"></iframe>').addClass("js-pulse-mobile-ad-active")}})}}function u(){if(n&&document.getElementById("js-pulse-mobile-img-ad")){document.getElementById("pulse-mobile-ad"),e(".pulse-mobile-wrapper").data("click");e("#js-pulse-mobile-img-ad").on("click",i)}}function c(){var n=document.getElementById("pulse-mobile-ad-iframe");if(n){var i=e(n).data("slick-index"),a=e(n).children(":first")[0],l=e(a).is("NOSCRIPT")?!0:!1,o=!1;i&&l&&t.on("beforeChange",function(t,l,r,s){if(s===i&&!o){var d=e(a).text();e(n).append(d),o=!0}})}}function p(){l(),a(),s(),d(),u(),c()}return{init:p}}();i.init()});
