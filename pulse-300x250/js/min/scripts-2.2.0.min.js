...
var PulseSlides=function(){function e(e,i){for(var t,r=/<%([^%>]+)?%>/g,a=/(^( )?(if|for|else|switch|case|break|{|}))(.*)?/g,s="var r=[];\n",l=0,c=function(e,i){return s+=i?e.match(a)?e+"\n":"r.push("+e+");\n":""!=e?'r.push("'+e.replace(/"/g,'\\"')+'");\n':"",c};t=r.exec(e);)c(e.slice(l,t.index))(t[1],!0),l=t.index+t[0].length;return c(e.substr(l,e.length-l)),s+='return r.join("");',new Function(s.replace(/[\r\t\n]/g,"")).apply(i)}function t(e){for(var i=e.length-1;i>0;i--){var t=Math.floor(Math.random()*(i+1)),r=e[i];e[i]=e[t],e[t]=r}return e}function r(e){return e&&!/.gif/i.test(e)&&(e="https://img.washingtonpost.com/wp-apps/imrs.php?src="+e+"&h=250&w=300"),e}function a(e){if(!e){var i=document.getElementsByClassName("pulse-mobile-wrapper")[0];e=i.getAttribute("data-click")}return e}function s(){function s(e){e.onclick=function(e){if(u){var i=document.createElement("img");i.alt="",i.border=0,i.src=u,i.style.width="1px",i.style.height="1px",i.style.display="none",h.appendChild(i)}}}if(document.getElementById("articles")){var c,n=document.getElementById("articles"),d=n.getAttribute("data-articles"),o=n.getAttribute("data-shuffle"),p=n.getAttribute("data-urlparam"),u=n.getAttribute("data-clicktrack"),h=document.getElementsByClassName("pulse-tracking-wrapper")[0];if(d=JSON.parse(d)){o?c=t(d).slice(0,3):(c=d.slice(0,3),c.reverse());var m=e(l.articles,{articles:c,linkTarget:function(e){return this.articles[e].sponsor?"_blank":"_top"},showArticles:!0,url_param:p?"?spon_con="+p:""})}var g=n.getAttribute("data-ad");if(g=JSON.parse(g),g&&"video"===g.type&&(g.videoTracking={},g.videoTracking.trackStart=g.trackstart||null,g.videoTracking.track25=g.track25||null,g.videoTracking.track50=g.track50||null,g.videoTracking.track75=g.track75||null,g.videoTracking.track100=g.track100||null,g.videoTracking=JSON.stringify(g.videoTracking)),g){var v=e(l[g.type],{ad:g,setAdClick:a,checkImgSrc:r});m=v+m}var f=document.createElement("div");for(f.innerHTML=m,i=0;i<f.childNodes.length;)el=f.childNodes[i],f.removeChild(el),n.insertBefore(el,n.firstChild);if(n.querySelectorAll){var k=n.querySelectorAll("a");for(i=0;i<k.length;i++)s(k[i])}}}var l={articles:'<%if(this.showArticles) {%><%for(var index in this.articles) {%><div class="js-pulse-mobile-article <%if(this.articles[index].sponsor) {%>slick-sponsor<%}%>"><div class="pulse-mobile-desc-wrapper"><div class="pulse-mobile-desc"><a href="<%this.articles[index].url%><%this.url_param%>" class="pulse-mobile-desc-link" target="<% this.linkTarget(index) %>"><p class="pulse-mobile-desc-text"><%this.articles[index].title%></p><p class="pulse-mobile-article-readmore">READ MORE <i class="fa fa-angle-double-right fa-1"></i></p></a></div><span class="pulse-mobile-logo"></span></div><img class="pulse-mobile-slide-img" data-lazy="https://img.washingtonpost.com/wp-apps/imrs.php?src=<%this.articles[index].src%>&w=300"></div><%}%><%} else {%><p>none</p><%}%>',html:'<div data-animate="true"><%this.ad.html%></div>',iframe:'<div data-animate="true"><iframe src="<%this.ad.src%>?clickTag=<% this.setAdClick(this.ad.url) %>" border="0" frameBorder="0" height="250" scrolling="no" width="300" style="border:0"></iframe></div>',image:'<div data-animate="true"><a href="<% this.setAdClick(this.ad.url) %>" target="_blank"><%if(this.ad.src) {%><img src="<% this.checkImgSrc(this.ad.src) %>" alt="" border="0" style="border:0" /><%}%></a></div>',video:'<div data-animate="true"><div class="pulse-player-wrapper" data-videotracking=\'<% this.ad.videoTracking %>\'><i class="fa fa-4x fa-play-circle-o pulse-player-play"></i><i class="fa fa-volume-up pulse-player-volume"></i><video id="pulse-player" class="pulse-player" data-current-time="0.25" poster="<% this.ad.poster_url %>"><%if(this.ad.src) {%><source src="<%this.ad.src%>" type="video/mp4" /><%}%></video></div></div>'};return{load:s}}();PulseSlides.load();
