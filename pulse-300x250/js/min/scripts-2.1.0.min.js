...
var PulseSlides=function(){function e(e,i){for(var a,r=/<%([^%>]+)?%>/g,t=/(^( )?(if|for|else|switch|case|break|{|}))(.*)?/g,s="var r=[];\n",l=0,d=function(e,i){return s+=i?e.match(t)?e+"\n":"r.push("+e+");\n":""!=e?'r.push("'+e.replace(/"/g,'\\"')+'");\n':"",d};a=r.exec(e);)d(e.slice(l,a.index))(a[1],!0),l=a.index+a[0].length;return d(e.substr(l,e.length-l)),s+='return r.join("");',new Function(s.replace(/[\r\t\n]/g,"")).apply(i)}function a(e){for(var i=e.length-1;i>0;i--){var a=Math.floor(Math.random()*(i+1)),r=e[i];e[i]=e[a],e[a]=r}return e}function r(){if(document.getElementById("articles")){var r,s=document.getElementById("articles"),l=s.getAttribute("data-articles"),d=s.getAttribute("data-shuffle"),c=s.getAttribute("data-urlparam");if(l=JSON.parse(l)){d?r=a(l).slice(0,3):(r=l.slice(0,3),r.reverse());var n=e(t.articles,{articles:r,showArticles:!0,url_param:c?"?spon_con="+c:""})}var o=s.getAttribute("data-ad");if(o=JSON.parse(o)){var p=e(t[o.type],{ad:o});n=p+n}var u=document.createElement("div");for(u.innerHTML=n,i=0;i<u.childNodes.length;)el=u.childNodes[i],u.removeChild(el),s.insertBefore(el,s.firstChild)}}var t={articles:'<%if(this.showArticles) {%><%for(var index in this.articles) {%><div class="js-pulse-mobile-article"><div class="pulse-mobile-desc-wrapper"><div class="pulse-mobile-desc"><a href="<%this.articles[index].url%><%this.url_param%>" class="pulse-mobile-desc-link" target="_top"><%if(this.articles[index].sponsor && this.articles[index].content_from) {%><label class="pulse-mobile-desc-label">content from <%this.articles[index].content_from%></label><%}%><p class="pulse-mobile-desc-text"><%this.articles[index].title%></p><p class="pulse-mobile-article-readmore">READ MORE <i class="fa fa-angle-double-right fa-1"></i></p></a></div></div><%if(this.articles[index].src) {%><img class="pulse-mobile-slide-img" data-lazy="https://img.washingtonpost.com/wp-apps/imrs.php?src=<%this.articles[index].src%>&w=300"><%}%></div><%}%><%} else {%><p>none</p><%}%>',html:'<div data-animate="true"><%this.ad.html%></div>',iframe:'<div data-animate="true"><iframe src="<%this.ad.src%>" border="0" frameBorder="0" height="250" scrolling="no" width="300" style="border:0"></iframe></div>',image:'<div data-animate="true"><%if(this.ad.url) {%><a href="<%this.ad.url%>"><%}%><%if(this.ad.src) {%><img src="<%this.ad.src%>" alt="" border="0" style="border:0" /><%}%><%if(this.ad.url) {%></a><%}%></div>',video:'<div data-animate="true"><div class="pulse-player-wrapper"><i class="fa fa-4x fa-play-circle-o pulse-player-play"></i><i class="fa fa-volume-up pulse-player-volume"></i><video id="pulse-player" class="pulse-player" data-current-time="0.25"><source src="<%this.ad.src%>" type="video/mp4" /></video></div></div>'};return{load:r}}();PulseSlides.load();
