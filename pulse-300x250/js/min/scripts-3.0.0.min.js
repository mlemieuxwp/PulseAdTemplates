...
var Templates=function(){function s(s,e){for(var i,a=/<%([^%>]+)?%>/g,l=/(^( )?(if|for|else|switch|case|break|{|}))(.*)?/g,r="var r=[];\n",t=0,c=function(s,e){return r+=e?s.match(l)?s+"\n":"r.push("+s+");\n":""!=s?'r.push("'+s.replace(/"/g,'\\"')+'");\n':"",c};i=a.exec(s);)c(s.slice(t,i.index))(i[1],!0),t=i.index+i[0].length;return c(s.substr(t,s.length-t)),r+='return r.join("");',new Function(r.replace(/[\r\t\n]/g,"")).apply(e)}var e={articles:'<%if(this.showArticles) {%><%for(var index in this.articles) {%><div class="js-pulse-mobile-article pulse-slide swiper-lazy <%if(this.sponsorAll || this.articles[index].sponsor) {%>slick-sponsor<%}%>" data-background="https://img.washingtonpost.com/wp-apps/imrs.php?src=<%this.articles[index].src%>&w=300" ><div class="pulse-mobile-desc-wrapper"><div class="pulse-mobile-desc"><a href="<%this.articles[index].url%><%this.url_param%>" class="pulse-mobile-desc-link" target="<% this.linkTarget(index) %>"><p class="pulse-mobile-desc-text"><%this.articles[index].title%></p><p class="pulse-mobile-article-readmore">READ MORE <i class="fa fa-angle-double-right fa-1"></i></p></a></div><span class="pulse-mobile-logo"></span></div><img class="pulse-mobile-slide-img" data-lazy="https://img.washingtonpost.com/wp-apps/imrs.php?src=<%this.articles[index].src%>&w=300"></div><%}%><%} else {%><p>none</p><%}%>',html:'<div data-animate="true" class="pulse-slide"><%this.ad.html%></div>',iframe:'<div data-animate="true" class="pulse-slide"><iframe src="<%this.ad.src%>?clickTag=<% this.setAdClick(this.ad.url) %>" border="0" frameBorder="0" height="250" scrolling="no" width="300" style="border:0"></iframe></div>',image:'<div data-animate="true" class="pulse-slide"><a href="<% this.setAdClick(this.ad.url) %>" target="_blank"><%if(this.ad.src) {%><img src="<% this.checkImgSrc(this.ad.src) %>" alt="" border="0" style="border:0" /><%}%></a></div>',video:'<div data-animate="true" class="pulse-slide"><div class="pulse-player-wrapper" data-videotracking=\'<% this.ad.videoTracking %>\'><i class="fa fa-4x fa-play-circle-o pulse-player-play"></i><i class="fa fa-volume-up pulse-player-volume"></i><video id="pulse-player" class="pulse-player" data-current-time="0.25" poster="<% this.ad.poster_url %>"><%if(this.ad.src) {%><source src="<%this.ad.src%>" type="video/mp4" /><%}%></video></div></div>'};return{engine:s,types:e}}();
...
var PulseCarousel=function(){function e(e,s){var a=e[0].swiper,l=(a.slides.length-1,document.getElementsByClassName("js-pulse-animate")[0]),t=document.getElementsByClassName("js-pulse-animate")[1];a.on("onSlideChangeStart",function(e){e.slides[e.activeIndex].classList.contains("slick-sponsor")&&!s(".pulse-mobile-wrapper").hasClass("pulse-sponsored")&&s(".pulse-mobile-wrapper").addClass("pulse-sponsored"),s(".js-pulse-animate").hasClass("closed")&&(l.classList.toggle("closed"),t.classList.toggle("closed")),e.slides[e.activeIndex].hasAttribute("data-animate")&&(l.classList.toggle("closed"),t.classList.toggle("closed"))}),a.on("onSlideChangeEnd",function(e){!e.slides[e.activeIndex].classList.contains("slick-sponsor")&&s(".pulse-mobile-wrapper").hasClass("pulse-sponsored")&&s(".pulse-mobile-wrapper").removeClass("pulse-sponsored")})}function s(e){e.append('<a class="pulse-prev"></a><a class="pulse-next"></a>'),new Swiper(e,{slideClass:"pulse-slide",wrapperClass:"pulse-mobile",preloadImages:!1,lazyLoading:!0,loop:!0,nextButton:".pulse-next",prevButton:".pulse-prev"})}function a(e){var s=_$(e).data("poster");s&&e.setAttribute("poster",s)}function l(e){var s=_$(e).data("src"),a=document.createElement("source");a.setAttribute("src",s),e.appendChild(a)}function t(){if(document.getElementById("pulse-player")){var e=document.getElementById("pulse-player"),s=e.parentNode.parentNode,t=_$(s).data("slick-index");$pulse.on("beforeChange",function(s,n,i,o){o===t?(a(e),l(e)):e.hasAttribute("playing")&&(e.pause(),_$(".pulse-player-active").removeClass("pulse-player-active"),_$(".pulse-player-pause").show(),e.removeAttribute("playing"))})}}function n(){if(document.getElementById("pulse-mobile-ad")){var e=document.getElementById("pulse-mobile-ad"),s=e.parentNode.parentNode,a=_$(s).data("slick-index");$pulse.on("beforeChange",function(s,l,t,n){if(!_$(e).hasClass("js-pulse-mobile-ad-active")&&n===a){var i=_$(e).data("iframe");_$(e).append('<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" height="250" width="300" src="'+i+'" topmargin="0" leftmargin="0" allowtransparency="1"></iframe>').addClass("js-pulse-mobile-ad-active")}})}}function i(e){if(e&&document.getElementById("js-pulse-mobile-img-ad")){document.getElementById("pulse-mobile-ad"),_$(".pulse-mobile-wrapper").data("click");_$("#js-pulse-mobile-img-ad").on("click",Utils.advClickThru)}}function o(){var e=document.getElementById("pulse-mobile-ad-iframe");if(e){var s=_$(e).data("slick-index"),a=_$(e).children(":first")[0],l=!!_$(a).is("NOSCRIPT"),t=!1;s&&l&&$pulse.on("beforeChange",function(l,n,i,o){if(o===s&&!t){var p=_$(a).text();_$(e).append(p),t=!0}})}}function p(){var a=$.proxy($.fn.find,$(document)),l=a(".pulse-mobile-wrapper"),p=a(".pulse-mobile-wrapper").data("click");s(l),e(l,a),t(),n(),i(p),o()}return{init:p}}();
var PulseSlides=function(){function e(e){function t(t){t=JSON.parse(t),c?r=Utils.shuffleArray(t).slice(0,3):(r=t.slice(0,3),r.reverse());var a=Templates.engine(Templates.types.articles,{articles:r,linkTarget:function(e){return this.articles[e].sponsor?"_blank":"_top"},showArticles:!0,sponsorAll:n,urlParam:s?"?spon_con="+s:""}),l=e.getAttribute("data-ad");if(l=JSON.parse(l),l&&"video"===l.type&&(l.videoTracking={},l.videoTracking.trackStart=l.trackstart||null,l.videoTracking.track25=l.track25||null,l.videoTracking.track50=l.track50||null,l.videoTracking.track75=l.track75||null,l.videoTracking.track100=l.track100||null,l.videoTracking=JSON.stringify(l.videoTracking)),l){var o=Templates.engine(Templates.types[l.type],{ad:l,setAdClick:Utils.setAdClick,checkImgSrc:Utils.checkImgSrc});a=o+a}var d=document.createElement("div");for(d.innerHTML=a,i=0;i<d.childNodes.length;)el=d.childNodes[i],d.removeChild(el),e.insertBefore(el,e.firstChild);if(e.querySelectorAll){var u=e.querySelectorAll("a");for(i=0;i<u.length;i++)Utils.clickTrackHandler(u[i])}}if(e){var r,a=e.getAttribute("data-articles"),l=e.getAttribute("data-feed"),c=(e.getAttribute("data-clicktrack"),document.getElementsByClassName("pulse-tracking-wrapper")[0],e.getAttribute("data-shuffle")),n=e.getAttribute("data-sponsorall")||!1,s=e.getAttribute("data-urlparam");l?xmlHttp.get(l,function(e){t(e.responseText),PulseCarousel.init()}):a&&t(a)}}function t(){var t=document.getElementById("articles");e(t)}return{init:t}}();
getScript(["jquery"],function(){var e=function(){function e(e){e&&(e=e.replace(/%%CACHEBUSTER%%/gi,""),e+=Math.floor(1e12*Math.random())+"?",o(".pulse-tracking-wrapper").append('<img src="'+e+'" alt="" border="0" height="1" width="1" style="display:none;" />'))}function a(){!$(c).attr("poster")&&$(c).data("current-time")&&(c.currentTime=$(c).data("current-time"))}function t(e){e.preventDefault(),window.open(d)}function l(e){e.preventDefault(),c.muted?(c.muted=!1,o(this).addClass("fa-volume-up"),o(this).removeClass("fa-volume-off")):(c.muted=!0,o(this).addClass("fa-volume-off"),o(this).removeClass("fa-volume-up"))}function r(a){a.preventDefault(),h.length&&isFirstClick&&(h.off("click"),isFirstClick=!1,o(c).on("click",t)),c.paused||c.ended?(e(f),c.play(),c.setAttribute("playing","true"),o(c).parent().addClass("pulse-player-active"),o(c).css("visibility","visible"),o(this).addClass("fa-pause-circle-o pulse-player-pause")):(c.pause(),c.removeAttribute("playing"),o(this).removeClass("fa-pause-circle-o pulse-player-pause"))}function i(){e(m),c.load(),!$(c).attr("poster")&&$(c).data("current-time")&&(c.currentTime=$(c).data("current-time")),$has_video_ctrls&&(o(c).parent().removeClass("pulse-player-active"),v.removeClass("fa-pause-circle-o pulse-player-pause").show())}function p(){o(".pulse-mobile-wrapper").on("mouseenter",".pulse-player-active",function(){v.fadeIn()}),o(".pulse-mobile-wrapper").on("mouseleave",".pulse-player-active",function(){v.fadeOut()})}function s(){h.length&&!c.hasAttribute("autoplay")?h.on("click",function(e){v.click()}):o(c).on("click",t)}function n(){y.on("click",l),v.on("click",r),s(),a(),o(c).on("ended",i)}function u(){n(),p()}var o=$.proxy($.fn.find,$(document)),c=document.getElementById("pulse-player"),d=o(".pulse-mobile-wrapper").data("click"),f=o(".pulse-player-wrapper").data("video-track-play")||o(".pulse-mobile-wrapper").data("track")||!1,m=o(".pulse-player-wrapper").data("video-track-end")||!1,v=o(".pulse-player-play"),y=o(".pulse-player-volume"),h=o(".pulse-player-wrapper");return $has_video_ctrls=!(o(".pulse-player-no-ctrls").length>0),isFirstClick=!0,{init:u}}();e.init()});
...
getScript(["jquery"],function(){$.proxy($.fn.find,$(document));PulseSlides.init()});