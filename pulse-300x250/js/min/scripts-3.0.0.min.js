...
var PulseCarousel=function(){function e(e,s){var a=e.slick("getSlick"),l=(a.slideCount-1,document.getElementsByClassName("js-pulse-animate")[0]),t=document.getElementsByClassName("js-pulse-animate")[1];e.on("beforeChange",function(e,a,n,i){a.$slides[i].classList.contains("slick-sponsor")&&!s(".pulse-mobile-wrapper").hasClass("pulse-sponsored")&&s(".pulse-mobile-wrapper").addClass("pulse-sponsored"),s(".js-pulse-animate").hasClass("closed")&&(l.classList.toggle("closed"),t.classList.toggle("closed")),a.$slides[i].hasAttribute("data-animate")&&(l.classList.toggle("closed"),t.classList.toggle("closed"))}),e.on("afterChange",function(e,a,l){!a.$slides[l].classList.contains("slick-sponsor")&&s(".pulse-mobile-wrapper").hasClass("pulse-sponsored")&&s(".pulse-mobile-wrapper").removeClass("pulse-sponsored")})}function s(e){e.slick({lazyLoad:"ondemand",rtl:!1})}function a(e){var s=_$(e).data("poster");s&&e.setAttribute("poster",s)}function l(e){var s=_$(e).data("src"),a=document.createElement("source");a.setAttribute("src",s),e.appendChild(a)}function t(){if(document.getElementById("pulse-player")){var e=document.getElementById("pulse-player"),s=e.parentNode.parentNode,t=_$(s).data("slick-index");$pulse.on("beforeChange",function(s,n,i,o){o===t?(a(e),l(e)):e.hasAttribute("playing")&&(e.pause(),_$(".pulse-player-active").removeClass("pulse-player-active"),_$(".pulse-player-pause").show(),e.removeAttribute("playing"))})}}function n(){if(document.getElementById("pulse-mobile-ad")){var e=document.getElementById("pulse-mobile-ad"),s=e.parentNode.parentNode,a=_$(s).data("slick-index");$pulse.on("beforeChange",function(s,l,t,n){if(!_$(e).hasClass("js-pulse-mobile-ad-active")&&n===a){var i=_$(e).data("iframe");_$(e).append('<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" height="250" width="300" src="'+i+'" topmargin="0" leftmargin="0" allowtransparency="1"></iframe>').addClass("js-pulse-mobile-ad-active")}})}}function i(e){if(e&&document.getElementById("js-pulse-mobile-img-ad")){document.getElementById("pulse-mobile-ad"),_$(".pulse-mobile-wrapper").data("click");_$("#js-pulse-mobile-img-ad").on("click",Utils.advClickThru)}}function o(){var e=document.getElementById("pulse-mobile-ad-iframe");if(e){var s=_$(e).data("slick-index"),a=_$(e).children(":first")[0],l=_$(a).is("NOSCRIPT")?!0:!1,t=!1;s&&l&&$pulse.on("beforeChange",function(l,n,i,o){if(o===s&&!t){var r=_$(a).text();_$(e).append(r),t=!0}})}}function r(){var a=$.proxy($.fn.find,$(document)),l=a(".pulse-mobile"),r=a(".pulse-mobile-wrapper").data("click");s(l),e(l,a),t(),n(),i(r),o()}return{init:r}}();
...
getScript(["jquery","slick"],function(){$.proxy($.fn.find,$(document));PulseSlides.init()});