var PulseArticles=function(){function e(e,t){for(var r,s=/<%([^%>]+)?%>/g,i=/(^( )?(if|for|else|switch|case|break|{|}))(.*)?/g,a="var r=[];\n",l=0,n=function(e,t){return a+=t?e.match(i)?e+"\n":"r.push("+e+");\n":""!=e?'r.push("'+e.replace(/"/g,'\\"')+'");\n':"",n};r=s.exec(e);)n(e.slice(l,r.index))(r[1],!0),l=r.index+r[0].length;return n(e.substr(l,e.length-l)),a+='return r.join("");',new Function(a.replace(/[\r\t\n]/g,"")).apply(t)}function t(e){for(var t=e.length-1;t>0;t--){var r=Math.floor(Math.random()*(t+1)),s=e[t];e[t]=e[r],e[r]=s}return e}function r(){if(document.getElementById("articles")){var r,i,a=document.getElementById("articles"),l=a.getAttribute("data-articles");a.getAttribute("data-shuffle");l=JSON.parse(l),i=t(l),r=i.slice(1,4);var n=e(s,{articles:r,showArticles:!0,addOne:function(e){return parseInt(e,10)+1}}),c=document.createElement("ul");c.className="pulse-article-list",c.innerHTML=n,a.parentNode.insertBefore(c,a);var u=a.parentNode;u.removeChild(a)}}var s='<%if(this.showArticles) {%><%for(var index in this.articles) {%><li class="pulse-article-list-item"><div class="pulse-article-thumb-wrapper"><a href="<%this.articles[index].url%>" target="_top"><img src="https://img.washingtonpost.com/wp-apps/imrs.php?src=<%this.articles[index].src%>&h=60&w=60" border="0" class="pulse-article-thumbnail" /></a></div><div class="pulse-article-number"><% this.addOne(index) %></div><div class="pulse-article-desc-wrapper"><p class="pulse-article-desc"><a href="<%this.articles[index].url%>" class="pulse-article-desc-link" target="_top"><%this.articles[index].title%></a></p></div></li><%}%><%} else {%><p>none</p><%}%>';return{loadArticles:r}}();PulseArticles.loadArticles();
