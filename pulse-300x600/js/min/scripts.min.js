...
getScript(["jquery"],function(){var e=$.proxy($.fn.find,$(document)),t=function(){function t(t){if(t){var a=Math.floor(1e7*Math.random())+"?";t+=a,e(".pulse-tracking-wrapper").append('<img src="'+t+'" alt="" border="0" height="1" width="1" style="display:none;" />')}}function a(){$(c).data("current-time")&&(c.currentTime=$(c).data("current-time"))}function p(e){e.preventDefault(),window.open(d)}function i(t){t.preventDefault(),c.muted?(c.muted=!1,e(this).removeClass("fa-volume-off")):(c.muted=!0,e(this).addClass("fa-volume-off"))}function l(a){a.preventDefault(),$video_wrapper.length&&isFirstClick&&($video_wrapper.off("click"),isFirstClick=!1,e(c).on("click",p)),c.paused||c.ended?(t(f),c.play(),e(c).parent().addClass("pulse-player-active"),e(c).css("visibility","visible"),e(this).addClass("fa-pause-circle-o pulse-player-pause")):(c.pause(),e(this).removeClass("fa-pause-circle-o pulse-player-pause"))}function n(){c.load(),$has_video_ctrls&&$video_play_button.removeClass("fa-pause-circle-o pulse-player-pause").show()}function r(){e(".pulse-wrapper").on("mouseenter",".pulse-player-active",function(){$video_play_button.fadeIn()}),e(".pulse-wrapper").on("mouseleave",".pulse-player-active",function(){$video_play_button.fadeOut()})}function o(){$video_wrapper.length&&!c.hasAttribute("autoplay")?$video_wrapper.on("click",function(e){$video_play_button.click()}):e(c).on("click",p)}function u(){e(".pulse-player-poster").on("click",p),$video_mute_button.on("click",i),$video_play_button.on("click",l),a(),o(),e(c).on("ended",n)}function s(){u(),r()}var c=document.getElementById("pulse-player"),d=e(".pulse-wrapper").data("click"),f=e(".pulse-wrapper").data("track")?e(".pulse-wrapper").data("track"):!1;return $video_play_button=e(".pulse-player-play"),$video_mute_button=e(".pulse-player-volume"),$video_wrapper=e(".pulse-player-wrapper"),$has_video_ctrls=e(".pulse-player-no-ctrls").length>0?!1:!0,isFirstClick=!0,{init:s}}();t.init()});
