var PulseArticles=function(){function e(e,t){for(var r,i=/<%([^%>]+)?%>/g,s=/(^( )?(if|for|else|switch|case|break|{|}))(.*)?/g,l="var r=[];\n",a=0,n=function(e,t){return l+=t?e.match(s)?e+"\n":"r.push("+e+");\n":""!=e?'r.push("'+e.replace(/"/g,'\\"')+'");\n':"",n};r=i.exec(e);)n(e.slice(a,r.index))(r[1],!0),a=r.index+r[0].length;return n(e.substr(a,e.length-a)),l+='return r.join("");',new Function(l.replace(/[\r\t\n]/g,"")).apply(t)}function t(e){if(e){for(var t=e.length-1;t>0;t--){var r=Math.floor(Math.random()*(t+1)),i=e[t];e[t]=e[r],e[r]=i}return e}}function r(r){function s(e){e.onclick=function(e){if(p){var t=document.createElement("img");t.alt="",t.border=0,t.src=p,t.style.width="1px",t.style.height="1px",t.style.display="none",f.appendChild(t)}}}if(r){var l,n=r,c=n.getAttribute("data-articles"),o=n.getAttribute("data-shuffle"),u=n.getAttribute("data-urlparam"),p=n.getAttribute("data-clicktrack"),h=n.getAttribute("data-maxlength")||3,d=n.getAttribute("data-sponsorall")||!1,f=document.getElementsByClassName("pulse-tracking-wrapper")[0];if(c){c=JSON.parse(c),l=o?t(c).slice(0,h):c.slice(0,h);var g=e(a,{articles:l,showArticles:!0,sponsorAll:d,sponCheck:function(e){var t="";return!this.sponsorAll&&this.articles[e].sponsor&&this.articles[e].content_from&&(t="sponsor"),t},url_param:u?"?spon_con="+u:""});if(n.innerHTML=g,n.querySelectorAll){var m=n.querySelectorAll("a");for(i=0;i<m.length;i++)s(m[i])}}}}function s(){if(n.querySelectorAll){var e=n.querySelectorAll(".pulse-article-number");for(i=0;i<e.length;i++)e[i].innerText=i+1}}function l(){for(var e=document.getElementsByClassName("pulse-article-list"),t=e.length;t--;)r(e[t]);s(),n.style.display="block"}var a='<%if(this.showArticles) {%><%for(var index in this.articles) {%><li class="pulse-article-list-item <% this.sponCheck(index) %>"><div class="pulse-article-wrapper cf"><div class="pulse-article-thumb-wrapper"><a href="<%this.articles[index].url%><%this.url_param%>" target="_top"><%if(this.articles[index].src) {%><img src="https://img.washingtonpost.com/wp-apps/imrs.php?src=<%this.articles[index].src%>&h=61&w=61" border="0" class="pulse-article-thumbnail" /><%}%></a></div><div class="pulse-article-number"></div><div class="pulse-article-desc-wrapper"><p class="pulse-article-desc"><a href="<%this.articles[index].url%><%this.url_param%>" class="pulse-article-desc-link" target="_top"><%this.articles[index].title%></a></p></div></div></li><%}%><%} else {%><p>none</p><%}%>',n=document.getElementById("articles");return{init:l}}();PulseArticles.init();
