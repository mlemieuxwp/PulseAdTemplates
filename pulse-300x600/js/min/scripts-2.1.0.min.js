var PulseArticles=function(){function e(e,t){for(var r,i=/<%([^%>]+)?%>/g,s=/(^( )?(if|for|else|switch|case|break|{|}))(.*)?/g,l="var r=[];\n",a=0,n=function(e,t){return l+=t?e.match(s)?e+"\n":"r.push("+e+");\n":""!=e?'r.push("'+e.replace(/"/g,'\\"')+'");\n':"",n};r=i.exec(e);)n(e.slice(a,r.index))(r[1],!0),a=r.index+r[0].length;return n(e.substr(a,e.length-a)),l+='return r.join("");',new Function(l.replace(/[\r\t\n]/g,"")).apply(t)}function t(e){if(e){for(var t=e.length-1;t>0;t--){var r=Math.floor(Math.random()*(t+1)),i=e[t];e[t]=e[r],e[r]=i}return e}}function r(r){function s(e){e.onclick=function(e){if(p){var t=document.createElement("img");t.alt="",t.border=0,t.src=p,t.style.width="1px",t.style.height="1px",t.style.display="none",d.appendChild(t)}}}if(r){var l,n=r,c=n.getAttribute("data-articles"),o=n.getAttribute("data-shuffle"),u=n.getAttribute("data-urlparam"),p=n.getAttribute("data-clicktrack"),h=n.getAttribute("data-maxlength")||3,d=document.getElementsByClassName("pulse-tracking-wrapper")[0];if(c){c=JSON.parse(c),l=o?t(c).slice(0,h):c.slice(0,h);var f=e(a,{articles:l,showArticles:!0,sponCheck:function(e){var t="";return this.articles[e].sponsor&&this.articles[e].content_from&&(t="sponsor"),t},url_param:u?"?spon_con="+u:""});if(n.innerHTML=f,n.querySelectorAll){var m=n.querySelectorAll("a");for(i=0;i<m.length;i++)s(m[i])}}}}function s(){var e=document.getElementById("articles");if(e.querySelectorAll){var t=e.querySelectorAll(".pulse-article-number");for(i=0;i<t.length;i++)t[i].innerText=i+1}}function l(){for(var e=document.getElementsByClassName("pulse-article-list"),t=e.length;t--;)r(e[t]);s()}var a='<%if(this.showArticles) {%><%for(var index in this.articles) {%><li class="pulse-article-list-item <% this.sponCheck(index) %>"><div class="pulse-article-wrapper cf"><div class="pulse-article-thumb-wrapper"><a href="<%this.articles[index].url%><%this.url_param%>" target="_top"><%if(this.articles[index].src) {%><img src="https://img.washingtonpost.com/wp-apps/imrs.php?src=<%this.articles[index].src%>&h=61&w=61" border="0" class="pulse-article-thumbnail" /><%}%></a></div><div class="pulse-article-number"></div><div class="pulse-article-desc-wrapper"><p class="pulse-article-desc"><a href="<%this.articles[index].url%><%this.url_param%>" class="pulse-article-desc-link" target="_top"><%if(this.articles[index].sponsor && this.articles[index].content_from) {%><label class="pulse-article-desc-label">content from <%this.articles[index].content_from%></label><%}%><%this.articles[index].title%></a></p></div></div></li><%}%><%} else {%><p>none</p><%}%>';return{init:l}}();PulseArticles.init();
