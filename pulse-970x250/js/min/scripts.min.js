...
!function(n){var i=n.proxy(n.fn.find,n(document)),o=i(".pulse-bb-slides"),d=function(){function n(){o.slick({lazyLoad:"ondemand",slidesToShow:2,slidesToScroll:1})}function i(){n()}return{init:i}}();d.init()}(parent.window.jQuery);